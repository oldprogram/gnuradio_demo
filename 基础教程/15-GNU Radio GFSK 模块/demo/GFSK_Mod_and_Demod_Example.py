...
class GFSK_Mod_and_Demod_Example(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "GFSK Mod and Demod", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GFSK Mod and Demod")
        ...
        self.settings = Qt.QSettings("GNU Radio", "GFSK_Mod_and_Demod_Example")
...
def main(top_block_cls=GFSK_Mod_and_Demod_Example, options=None):
